        ...
        <main class="col-md-11 col-lg-10 px-md-4">
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.partials.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="validated" class="form-label">Statut de validation</label>
                                <select class="form-select @error('validated') is-invalid @enderror" id="validated" name="validated" required>
                                    <option value="0" {{ old('validated', $project->validated) == 0 ? 'selected' : '' }}>En attente</option>
                                    <option value="1" {{ old('validated', $project->validated) == 1 ? 'selected' : '' }}>Validé</option>
                                </select>
                                @error('validated')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
